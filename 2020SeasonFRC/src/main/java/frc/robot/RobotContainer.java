...
public class RobotContainer {
  ...
  private final JoystickButton runMotorButton = new JoystickButton(controller1, 0); //TODO: Change the 0 here to the button ID desired. Use DriverStation to find a button you would like
  ...
  private void configureButtonBindings() {
    ...
    runMotorButton.whenPressed(motorMovementCommand, true);
  }
